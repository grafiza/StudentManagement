...
@PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
public ResponseMessage <TeacherResponse> chooseLesson(@RequestBody @Valid ChooseLessonTeacherRequest lessonTeacherRequest){
    return teacherService.addLessonProgram(lessonTeacherRequest);
    }
}
