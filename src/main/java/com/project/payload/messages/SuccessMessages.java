...
public class SuccessMessages {
    ...
    public static final String STUDENT_INFO_DELETED = "Student Info is deleted Successfully";
    ...
    public static final String MEET_DELETE_MESSAGE = "Meet is deleted Successfully";
}
